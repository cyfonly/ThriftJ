...
public class ThriftClient2 {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 servers(String servers) {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 loadBalance(int loadBalance) {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 connectionValidator(ConnectionValidator validator) {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 poolConfig(GenericKeyedObjectPoolConfig poolConfig) {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 failoverStrategy(FailoverStrategy failoverStrategy) {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 connTimeout(int connTimeout) {
     ...
     * @return ThriftClient
     */
    public ThriftClient2 backupServers(String backupServers) {
